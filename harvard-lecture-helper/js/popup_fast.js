...
$(document).ready(function () {
    ...
    // NOTE Perhaps the injection is causing the .3 sec slowdown?
    // TODO Look into simplifying the injection script, or maybe moving it to a separate, call-able JS file?
    // TODO Ask Adam if the run-time needs to be executed live and per-click on the menu, or just needs to be alive in the background.
